...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "javacompreseujogo@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("1234"));
		Cliente cli2 = new Cliente(null, "Geovanni Corsino", "java.compreseujogo@gmail.com", "48997676091", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("1234"));
		cli2.addPerfil(Perfil.ADMIN);
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.getTelefones().addAll(Arrays.asList("98452315", "93838393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		
		Endereco e3 = new Endereco(null, "Rua do joão", "105", "Sala 800", "Centro", "38777012", cli2, c2);
