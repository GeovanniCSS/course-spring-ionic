...
public class DBService {
	...
	@Autowired
	private PedidoRepository bCryptPasswordEncoderdidoRepository;
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli2 = new Cliente(null, "Geovanni Corsino", "java.compreseujogo@gmail.com", "31628382740", TipoCliente.PESSOAFISICA,
		...
		Pedido bCryptPasswordEncoderd1 = new Pedido(null, sdf.parse("30/09/2017 10:32"), cli1, e1);
		Pedido bCryptPasswordEncoderd2 = new Pedido(null, sdf.parse("10/10/2017 19:35"), cli1, e2);

		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, bCryptPasswordEncoderd1, 6);
		bCryptPasswordEncoderd1.setPagamento(pagto1);

		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, bCryptPasswordEncoderd2,
				sdf.parse("20/10/2017 00:00"), null);
		bCryptPasswordEncoderd2.setPagamento(pagto2);

		cli1.getPedidos().addAll(Arrays.asList(bCryptPasswordEncoderd1, bCryptPasswordEncoderd2));

		bCryptPasswordEncoderdidoRepository.saveAll(Arrays.asList(bCryptPasswordEncoderd1, bCryptPasswordEncoderd2));
		pagamentoRepository.saveAll(Arrays.asList(pagto1, pagto2));

		ItemPedido ip1 = new ItemPedido(bCryptPasswordEncoderd1, p1, 0.00, 1, 2000.00);
		ItemPedido ip2 = new ItemPedido(bCryptPasswordEncoderd1, p3, 0.00, 2, 80.00);
		ItemPedido ip3 = new ItemPedido(bCryptPasswordEncoderd2, p2, 100.00, 1, 800.00);

		bCryptPasswordEncoderd1.getItens().addAll(Arrays.asList(ip1, ip2));
		bCryptPasswordEncoderd2.getItens().addAll(Arrays.asList(ip3));
