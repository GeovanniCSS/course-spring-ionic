...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat3 = new Categoria(1, "fIFA");
		Categoria cat4 = new Categoria(2, "sHOW");
		Categoria cat5 = new Categoria(1, "haha");
		Categoria cat6 = new Categoria(2, "afsafas");
		Categoria cat7 = new Categoria(1, "sete");
		Categoria cat8 = new Categoria(2, "oito");
